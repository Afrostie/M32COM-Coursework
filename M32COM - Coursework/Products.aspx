    ...
    <asp:Panel ID="pnlAdmin" runat="server" Visible="False">
        <div class="products clearfix">
            ...
            <div class="col-md-12">
                ...
                <br />
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Out of Range" ControlToValidate="txtBoxCakeDescription" ForeColor="Red" ToolTip="Out of Range" ValidationExpression="\w{8,400}">*</asp:RegularExpressionValidator>
